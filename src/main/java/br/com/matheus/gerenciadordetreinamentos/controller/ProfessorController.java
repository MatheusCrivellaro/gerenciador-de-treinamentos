...
public class ProfessorController  {
    ...
    @Operation(summary = "Desativa um Professor", description = "Desativa um Professor pelo ID, que é recebido pelo Path, os dados permanecerão no banco de dados, porém serão desconsiderados na maior parte das operações, via de regra apenas Professores tem acesso a esses dados.", tags = {"Professor"})
    @DeleteMapping("/{id}")
